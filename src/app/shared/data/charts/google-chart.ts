...
export var barChart2: any = {
 ...
 export var pieChart:  any = {
  ...
  options: {
    width : 550,
    height : 400,
    colors: ["#f8d62b", "#7dc006" , "#a927f9"  , secondary_color , primary_color ]
  }
 }
...
export var pieChart1: any ={
  ...
  options: {
    ...
    slices: {  4: {offset: 0.2},
      ...
      colors: [primary_color, secondary_color, "#7dc006", "#a927f9", "#f8d62b", "#d22d3d","#e6edef", primary_color, secondary_color, "#7dc006", "#a927f9", "#f8d62b","#d22d3d", primary_color, secondary_color, "#7dc006", "#a927f9", "#f8d62b", "#d22d3d", primary_color,secondary_color, "#7dc006"]
  }
} 
...
export var pieChart2: any ={
  ...
  options: {
    ...
    width:'100%',
    height: 300,
    colors: [primary_color, secondary_color, "#f8d62b", "#7dc006", "#a927f9"]
  }
} 
...
export var pieChart3: any ={
  ...
  options: {
    ...
    width:'100%',
    height: 300,
    colors: [secondary_color, primary_color, "#7dc006", "#a927f9", "#f8d62b"]
  }
} 
...
export var pieChart4: any ={
  ...
  options: {
    ...
    width:'100%',
    height: 300,
    colors: [primary_color, primary_color, "#f8d62b", "#7dc006", "#a927f9"]
  }
} 
