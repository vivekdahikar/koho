  ...
  MENUITEMS: Menu[] = [
    ...
    },
    {
      ...
      children: [
        ...
        { path: "/page-layout/Dark-layout", title: "Dark-layout", type: "link" },
    ...
    { path: "/kanban-board", title: "Kanban board", icon: "board", type: "link" },
      ...
      children: [
        ...
        },
        {
          ...
          children: [
            ...
            { path: "/forms/form-widgets/timepicker", title: "Timepicker", type: "link" },
            { path: "/forms/form-widgets/date-timepicker", title: "DateTimePicker", type: "link" },
        ...
        },
        {
          ...
          children: [
            ...
            { path: "/forms/form-layout/form-wizard1", title: "Form Wizard 1", type: "link" },
            { path: "/forms/form-layout/form-wizard2", title: "Form Wizard 2", type: "link" },
            { path: "/forms/form-layout/form-wizard3", title: "Form Wizard 3", type: "link" },
          ],
        },
      ],
    },
    {
      ...
      children: [
        ...
        { path: "/tables/ex-data-table", title: "Ex. Data Table", type: "link" },
    ...
    { path: "/landing-page", title: "landing Page", icon: "buttons", type: "link" },
    { path: "/starter kit", title: "Starter Kit", icon: "buttons", type: "link" },
